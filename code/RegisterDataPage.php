...
class RegisterDataPage extends Page
{
     ...
     * @var string
     */
    public static $email_sender ='testemails@silverstripe.com';
...
class RegisterDataPage_Controller extends Page_Controller
{
     ...
     */
    public function doRegisterMetadata($data, $form)
    {
     ...
     */
    public function doSendEmailToAdministrator($customFields, $templateName='ConfirmationEMail')
    {
        //checks

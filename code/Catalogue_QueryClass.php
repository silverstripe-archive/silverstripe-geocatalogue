...
class Catalogue_QueryClass
{
    ...
    public function __construct($params)
    {
        ...
        if (isset($params['startPosition'])) {
            $this->query['startPosition'] = $params['startPosition'];
        }
        if (isset($params['sortBy'])) {
            $this->query['sortBy'] = $params['sortBy'];
        }
        if (isset($params['sortOrder'])) {
            $this->query['sortOrder'] = $params['sortOrder'];
        }
        if (isset($params['bboxUpper'])) {
            $this->query['bboxUpper'] = $params['bboxUpper'];
        }
        if (isset($params['bboxLower'])) {
            $this->query['bboxLower'] = $params['bboxLower'];
        }
    }

...
class MDMetadata extends MDDataObject
{
     ...
     */
    public static $online_resource_web_url_filter = array(
     ...
     */
    public static function set_online_resource_web_url_filter($value)
    {
        self::$online_resource_web_url_filter = $value;
    }

    public static function get_online_resource_web_url_filter()
    {

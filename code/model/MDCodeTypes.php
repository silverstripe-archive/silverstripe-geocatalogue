...
class MDCodeTypes extends Object
{
    ...
    public static $default_for_null_value = 'Not Available';

    public static $MDOnlineResourceFunction = array(
//		"" => "",
        "download" => "Download",
    ...
    public static $MDResourceFormat = array(
    ...
    public static $MDCategory = array(
        "biota" => "Biota",
    ...
    public static $MDResourceConstraints = array(
        "copyright" => "Copyright",
    ...
    public static $MDDateTypes = array(
        "creation" => "Creation",
        "publication" => "Publication",
        "revision" => "Revision"
    );

    public static $useLimitation = array(
        "" => "",
    ...
    public static $MDSpatialRepresentationType = array(
        "grid" => "Grid",
    ...
    public static $MDOnlineResourceProtocol = array(
//		"" => "",
    ...
    public static $MDScopeCode = array(
    ...
    public static function get_online_resource_function()
    {
    ...
    public static function get_scope_codes_keys()
    {
        $result=array();
    ...
    public static function get_online_resource_protocol()
    {
        return self::$MDOnlineResourceProtocol;
    }

    public static function get_resource_formats()
    {
    ...
    public static function get_resource_constraints()
    {
        return self::$MDResourceConstraints;
    }
    
    public static function get_date_types()
    {
        return self::$MDDateTypes;
    }
    
    public static function get_use_limitation()
    {
        return self::$useLimitation;
    }

    public static function get_spatial_representation_type()
    {

...
class GnPublishMetadataCommandTest extends SapphireTest
{
     ...
     *
     */
    public function testGnPublishMetadataCommand()
    {
        $data = array();
        $data['gnID'] = 1963;
     ...
     *
     */
    public function testGnPublishMetadataCommandWithUnexpectedId()
    {
        $data = array();
        $data['gnID'] = 2009;
    ...
    * resulting in an exception
     */
    public function testGnPublishMetadataCommandWithNullId()
    {
        $data = array();
        $data['gnID'] = 1234;
...
class GnPublishMetadataCommandTest_Controller extends Controller implements TestOnly
{
     ...
     */
    public function getrecords($httprequest)
    {
        $paramid=$_POST['id'];
        ...
        if ($paramid == 1234) {
            return "<?xml version=\"1.0\" encoding=\"UTF-8\"?><Failresponse></Failresponse>";
        }

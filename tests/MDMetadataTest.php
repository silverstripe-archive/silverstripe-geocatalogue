...
class MDMetadataTest extends SapphireTest
{
     ...
     */
    public function testLoadDataWithValidContent()
    {
     ...
     */
    public function testLoadMDContactWithValidContent()
    {
        $metadata  = new MDMetadata();
        $item      = $this->getTestItem();
        $metadata->loadData($item);
     ...
     */
    public function testLoadCIOnlineResourcesWithValidContent()
    {
        $metadata  = new MDMetadata();
        $item      = $this->getTestItem();
        $metadata->loadData($item);
     ...
     */
    public function testLoadMDResourceFormatsWithValidContent()
    {
        $metadata  = new MDMetadata();
        $item      = $this->getTestItem();
        $metadata->loadData($item);
     ...
     */
    public function testLoadMDResourceConstraintsWithValidContent()
    {
        $metadata  = new MDMetadata();
        $item      = $this->getTestItem();
    ...
    *
    */
    public function testCIOnlineResources_WebAddresses()
    {
    ...
    */
    public function testgetSpatialRepresentationTypeNice()
    {
        $metadata  = new MDMetadata();
        $item      = $this->getTestItem();
        $metadata->loadData($item);

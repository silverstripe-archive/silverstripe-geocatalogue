...
class GnCreateInsertCommandTest extends SapphireTest
{
     ...
     *
     */
    public function testGnCreateInsertCommand()
    {
     ...
     *
     */
    public function testGnCreateInsertCommandWithEmptyData()
    {
        //seting up the environment
        $metadata = new MDMetadata;
        $data = array(
     ...
     *
     */
    public function testGnCreateInsertCommandWithoutDataObject()
    {
        //seting up the environment
        $data = array();
        $cmd = $this->controller->getCommand("GnCreateInsert", $data);
     ...
     *
     */
    public function testGnCreateInsertCommandWithWrongDataObjectType()
    {
        //seting up the environment

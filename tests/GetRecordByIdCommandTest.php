...
class GetRecordByIdCommandTest extends SapphireTest
{
     ...
     */
    public static $fixture_file = 'geocatalogue/tests/GetRecordByIdCommandTest.yml';
     ...
     */
    public function testGetRecordByIdCommand()
    {
     ...
     * @see GetRecordByIdCommandTest_Controller
     */
    public function testGetRecordByIdCommandWithLessThenInID()
    {
     ...
     * @see GetRecordByIdCommandTest_Controller
     */
    public function testGetRecordByIdCommandWithQuoteInID()
    {
        $id           = 'with \' here';
        $outputFormat = 'html';
        $format       = 'iso';
